    ...
    <div class="modal-content">
        ...
        <form id="formPregunta">
            ...
            <div class="form-group">
                ...
                <input type="text" id="pregunta" name="pregunta" required class="form-control" style="width:100%; padding:8px;">
            </div>
            
            <div class="form-group">
                <label>Respuesta</label>
                <textarea id="respuesta" name="respuesta" rows="5" required class="form-control" style="width:100%; padding:8px;"></textarea>
            </div>
